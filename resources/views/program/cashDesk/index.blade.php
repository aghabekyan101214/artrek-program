...
@section('content')
   <div class="row">
        <div class="col-md-12">
            ...
            <div class="alert alert-success">Cash: {{ $cash }}</div>
            <div class="alert alert-success">Transfer: {{ $transfer }}</div>
            <div class="alert alert-success">Whole Sum: {{ $transfer + $cash }}</div>
        </div>
    </div>
@endsection
