   ...
   <div class="row">
        <div class="col-md-12">
            <div class="white-box">
                ...
                <a data-route="{{ app('router')->getRoutes()->match(app('request')->create($route."/create"))->getName() }}" href="{{$route."/create"}}" class="btn btn-success m-b-30"><i class="fas fa-plus"></i> Ավելացնել Հաճախորդ</a>
                        ...
                        @foreach($data as $key=>$val)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form data-route="services.destroy" style="display: inline-block" action="{{ $route."/".$val->id }}"
